...
""" % {'collectordb': self.db_file}
    ...
    self.assertEqual(result['result']['failed'], True)
    message = "Free disk space low: remaining 269.10 G (disk size: 417 G, threshold: 278 G). " \
      "The partition slapuser0 uses 83.48 G (date checked: 2017-10-02 09:17:00). " \
      "The partition slapuser2 uses 41.74 G (date checked: 2017-10-02 09:17:00). " \
      "The partition slapuser1 uses 20.87 G (date checked: 2017-10-02 09:17:00)."
    self.assertIn(message, result['result']['message'])
