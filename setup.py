...
setup(name=name,
      ...
      extras_require = {
        ...
        'pandas' : ['pandas'], # needed to monitor_partition_space and to display partition in check_free_disk_space
        'prediction' : ['statsmodels', 'scipy'], # needed to use ARIMA in check_free_disk_space
        'test': test_require,
      },
